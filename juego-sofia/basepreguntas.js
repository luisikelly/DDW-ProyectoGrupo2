let basepreguntas = [
    {
        pregunta: "¿Qué significa esta demarcación amarilla en la calzada?",
        imagen: "https://i.ibb.co/ZTWf7Sx/dobleamarilla.jpg",
        respuesta: "Indica, para ambos sentidos de circulación, que no debe ser traspasada ni se puede circular sobre ella",
        distractores: ["Señalización que divide carriles en la vía", "Circulación de solo vehículos particulares", "Ninguna es correcta"]
    },
    {
    ...
    },
    {
        ...
        respuesta: "Las luces altas",
        distractores: ["Las luces bajas", "Luces de posición", "Todas a la vez"]
    }
];
